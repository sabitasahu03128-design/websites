...
5. Process the parameters, interact with the system server through the https://danbooru.donmai.us/posts/3553474binder, and process the result to output the text result.
